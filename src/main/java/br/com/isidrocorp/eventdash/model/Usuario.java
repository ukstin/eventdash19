...
@Entity		// significa que a classe usuário é uma entidade armazenável em banco
@Table(name="itmn_usuario") // defino o nome da tabela
public class Usuario {
	
	@Column(name = "id_usuario")	// defino o nome da coluna
	@Id						        // indica que este atributo corresponde a uma PK
